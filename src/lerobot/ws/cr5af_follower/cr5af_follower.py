...
from lerobot.ws.cr5af_follower import CR5AFFOLLOWERConfig
from lerobot.ws.cr5af_follower.dobot_api_bak import DobotApiDashboard, DobotApiFeedBack
...
if __name__ == "__main__":
    ...
    robot = CR5AFFollower(robot_cfg)  # FOR CR5AF
    robot.connect()  # ！！！！！！！！！！！！！！！！
    robot.send_action({"joint1.pos": 0.0,
                       ...
                       "joint5.pos": -90.0,
                       "joint6.pos": 0.0,
                       "joint7.pos": 28.0,  # 夹爪张开
                       })
    
    while True:
        obs = robot.get_observation()
        # print("obs from robot:", obs)
        print("obs from robot:", {k: v for k, v in obs.items() if k != "front"})
